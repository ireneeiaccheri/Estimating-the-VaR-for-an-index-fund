...
The main idea is to estimate Value at Risk (VaR) and see how traditional models hold up against the GARCH approach. Real-world financial markets frequently experience "volatility clustering," and by comparing the computations and plots—as detailed in the attached paper—we concluded that the GARCH model more accurately captures potential losses.
